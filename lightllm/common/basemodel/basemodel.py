...
class TpPartBaseModel:
    ...
    def __init__(self, tp_rank, world_size, weight_dir, max_total_token_num, load_way="HF", mode=[], max_request_num=1000, max_sequence_length=5120):
    ...
    def _prefill(self, batch_size, total_token_num, max_len_in_batch, input_ids, b_loc, b_loc_idx, b_start_loc, b_seq_len):
        ...
        assert (b_start_loc.shape[0] == b_seq_len.shape[0])
        ...
        init_bloc(b_loc, b_loc_idx, b_seq_len, max_len_in_batch, infer_state.prefill_mem_index)
