...
class TpPartBaseModel:
    ...
    def _check_mem_size(self):
        ...
        assert self.max_seq_length <= self.max_total_token_num, f"max_seq_length {self.max_seq_length} should be less than or equal to max_total_token_num {self.max_total_token_num}"
        return
