...
class InternlmTpPartModelWQuant(LlamaTpPartModel):
    # weight class
    transformer_weight_class = InternlmTransformerLayerWeightQuantized

    # infer class
    transformer_layer_infer_class = InternlmTransformerLayerInferWquant
